  ...
  public boolean onTouchEvent(MotionEvent event) {
    ...
    switch (action) {
      case MotionEvent.ACTION_DOWN:
        ...
        Log.d(MainActivity.APP_CODE, "touch action down ");
        break;
      case MotionEvent.ACTION_MOVE:
        Log.d(MainActivity.APP_CODE, "touch action move ");
        ...
        int outputColor = getColor();
        Log.d(MainActivity.APP_CODE, "touch action down/move");
        listener.newColorPicked(Color.red(outputColor),
          Color.green(outputColor),
          Color.blue(outputColor));
        //return true;
        break;
      case MotionEvent.ACTION_HOVER_MOVE:
        Log.d(MainActivity.APP_CODE, "touch action hover move ");
        break;
      case MotionEvent.ACTION_SCROLL:
        Log.d(MainActivity.APP_CODE, "touch action scroll ");
        break;
      case MotionEvent.ACTION_UP:
        Log.d(MainActivity.APP_CODE, "touch action up ");
        break;
    }
